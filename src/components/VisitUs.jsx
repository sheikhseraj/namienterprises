...
const MAP_SRC = "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3507.4787!2d77.29470000000001!3d28.506600000000003!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390ce1b18e6df2ff%3A0x1!2sJaitpur%20Extension%20Part%202%2C%20Badarpur%2C%20New%20Delhi%2C%20Delhi%20110044!5e0!3m2!1sen!2sin!4v1748700000000"

function ContactCard({ inView }) {
  return (
    <div style={{
      ...
      <div style={{ padding: '20px 24px 16px', borderBottom: '1px solid rgba(255,255,255,0.08)' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 8 }}>
          <div style={{
            ...
            boxShadow: '0 0 0 3px rgba(196,154,60,0.2)',
...
export default function VisitUs() {
  ...
  return (
    <section id="visit" style={{ background: '#2C1200', overflow: 'hidden' }}>
      ...
      {/* Heading */}
      <div style={{ maxWidth: 1280, margin: '0 auto', padding: '80px 40px 48px' }} className="section-pad-x">
        <motion.div ref={ref}
      ...
      <div className="md:hidden" style={{ padding: '0 20px 40px' }}>
        <motion.div
          initial={{ opacity: 0, y: 24 }} animate={inView ? { opacity: 1, y: 0 } : {}}
          transition={{ duration: 0.6, delay: 0.2 }}>
          <ContactCard inView={inView} />
        </motion.div>
        <div style={{ marginTop: 16, borderRadius: 16, overflow: 'hidden', height: 260 }}>
          <iframe
            title="Nami Enterprises Location"
            width="100%" height="100%"
            style={{ border: 0, display: 'block', filter: 'saturate(0.55) contrast(1.05) brightness(0.8)' }}
        ...
        <a href="https://maps.google.com/?q=Jaitpur+Extension+Part+2+Badarpur+New+Delhi+110044"
          target="_blank" rel="noopener noreferrer"
          style={{ display: 'flex', alignItems: 'center', gap: 6, color: '#4a6580', fontSize: 10, textDecoration: 'none', marginTop: 10, justifyContent: 'flex-end' }}>
          Open in Google Maps <ExternalLink size={10} />
        </a>
      </div>

      {/* ── DESKTOP layout (overlay) ── */}
      <div className="hidden md:block" style={{ position: 'relative', height: 620 }}>
        ...
        <motion.iframe
          ...
          title="Nami Enterprises Location"
          width="100%" height="100%"
          style={{ border: 0, display: 'block', position: 'absolute', inset: 0, filter: 'saturate(0.55) contrast(1.05) brightness(0.8)' }}
          loading="lazy" allowFullScreen referrerPolicy="no-referrer-when-downgrade"
          src={MAP_SRC}
        />

        <div style={{ position: 'absolute', inset: 0, pointerEvents: 'none', zIndex: 2, background: 'linear-gradient(to right, rgba(44,18,0,0.92) 0%, rgba(44,18,0,0.65) 35%, rgba(44,18,0,0.1) 65%, rgba(44,18,0,0) 100%)' }} />
        <div style={{ position: 'absolute', inset: 0, pointerEvents: 'none', zIndex: 2, background: 'linear-gradient(to bottom, rgba(44,18,0,0.5) 0%, transparent 18%, transparent 82%, rgba(44,18,0,0.7) 100%)' }} />
        <div style={{ position: 'absolute', top: 0, left: 0, width: 280, height: 280, pointerEvents: 'none', zIndex: 3, background: 'radial-gradient(circle at top left, rgba(201,130,26,0.18), transparent 65%)' }} />

        <motion.div
          initial={{ opacity: 0, x: -28 }} animate={inView ? { opacity: 1, x: 0 } : {}}
          transition={{ duration: 0.7, delay: 0.4 }}
          style={{ position: 'absolute', top: 32, left: 40, bottom: 32, width: 340, zIndex: 10, display: 'flex', flexDirection: 'column', gap: 12 }}>
          <ContactCard inView={inView} />
          <a href="https://maps.google.com/?q=Jaitpur+Extension+Part+2+Badarpur+New+Delhi+110044"
            target="_blank" rel="noopener noreferrer"
            style={{ display: 'flex', alignItems: 'center', gap: 6, color: '#4a6580', fontSize: 10, textDecoration: 'none', justifyContent: 'flex-end' }}>
            Open in Google Maps <ExternalLink size={10} />
          </a>
        </motion.div>
        ...
        <motion.div
          ...
          style={{ position: 'absolute', bottom: 24, right: 24, zIndex: 10, display: 'flex', alignItems: 'center', gap: 10, background: 'rgba(201,130,26,0.14)', border: '1px solid rgba(201,130,26,0.38)', backdropFilter: 'blur(14px)', WebkitBackdropFilter: 'blur(14px)', borderRadius: 12, padding: '10px 16px' }}>
